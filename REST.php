 ...
 */
class RESTCollectionPlain extends RESTCollection {
...
} // class RESTCollectionPlain


/**
 * Displays content in plain text format (tab delimited)
 */
class RESTCollectionCSV extends RESTCollection {
 ...
 * Displays content in plain text format (tab delimited)
 */
class RESTCollectionHTML extends RESTCollection {


  private function start() {
    echo Portal::html_start('Directory index');
...
EOS;
  ...
  public function end() {
    ...
    echo "</tbody></table>" . Portal::html_end();
  }


} // class RESTCollectionHTMLz
 ...
 */
class RESTCollectionJSON extends RESTCollection {
